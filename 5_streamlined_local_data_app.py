    ...
    if 'json_data' in st.session_state:
        ...
        if people_options:
            ...
            if selected_person:
                ...
                with col1:
                    if st.button("🏢 Extract Companies", type="primary", use_container_width=True):
...
""" + person_json
                                ...
                                st.markdown("### ChatGPT Analysis Results:")
                ...
                with col2:
                    if st.button("🔍 Analysis 2", type="primary", use_container_width=True):
                        st.info("Button 2 functionality will be implemented next!")
