                        ...
                        if company_data:
                            with st.spinner(f"Creating structured analysis for {selected_company}..."):
                                try:
                                    ...
                                    query = f"""Create a comprehensive structured table analysis of {selected_company} showing how the company presents across all associated people. Format as detailed tables with the following information:
...
- Organize by WHO, WHAT, WHERE, WHEN, HOW

**TABLE 1: PERSONNEL OVERVIEW**
| Full Name | Primary Role/Title | Connection Type | Years Associated | Current Status | Key Skills/Expertise |

**TABLE 2: GEOGRAPHIC DISTRIBUTION**
| Location/Region | Number of People | Key Roles | Strategic Importance | Time Period |

**TABLE 3: ORGANIZATIONAL STRUCTURE**
| Department/Function | Personnel Count | Key Leaders | Core Capabilities | Evolution Timeline |

**TABLE 4: TEMPORAL ANALYSIS**
| Time Period | New Joiners | Departures | Role Changes | Strategic Shifts | Key Events |

**TABLE 5: CONNECTION MAPPING**
| Person Name | Connection Field/Type | Relationship Strength | External Networks | Influence Level |

**TABLE 6: CAPABILITY MATRIX**
| Skill/Expertise Area | Number of People | Experience Level | Innovation Potential | Market Value |

**SUMMARY INSIGHTS:**
- Key patterns in how the company presents through its people
- Timeline of organizational development
- Strategic capabilities and competitive advantages
- Geographic and functional distribution analysis

Analyze the provided data and create these structured tables with specific information from the company data.
